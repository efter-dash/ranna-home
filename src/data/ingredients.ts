...
export const INGREDIENT_DATA: Ingredient[] = [
  ...
  { id: "ess-dry-red-chili", name: "Dry Red Chili", localName: "শুকনো মরিচ", category: "Essential", imageQuery: "dried red chili", icon: "local_fire_department", image: "https://images.unsplash.com/photo-1588252303782-cb80119abd6d?w=400&h=400&fit=crop" },
  { id: "ess-bay-leaf", name: "Bay Leaf", localName: "তেজপাতা", category: "Essential", imageQuery: "bay leaves", icon: "eco", image: "https://images.unsplash.com/photo-1600788907416-272b36c2e0da?w=400&h=400&fit=crop" },
  { id: "ess-cardamom", name: "Cardamom", localName: "এলাচ", category: "Essential", imageQuery: "cardamom pods", icon: "spa", image: "https://images.unsplash.com/photo-1599909533601-aa23a47b882c?w=400&h=400&fit=crop" },
  { id: "ess-cinnamon", name: "Cinnamon", localName: "দারুচিনি", category: "Essential", imageQuery: "cinnamon sticks", icon: "spa", image: "https://images.unsplash.com/photo-1587049016823-69ef9d68f4b3?w=400&h=400&fit=crop" },
  ...
  { id: "ess-coriander-powder", name: "Coriander Powder", localName: "ধনিয়া গুঁড়া", category: "Essential", imageQuery: "coriander powder", icon: "spa", image: "https://images.unsplash.com/photo-1596547609652-9cf5d8c76921?w=400&h=400&fit=crop" },
  { id: "ess-garam-masala", name: "Garam Masala", localName: "গরম মশলা", category: "Essential", imageQuery: "garam masala powder", icon: "spa", image: "https://images.unsplash.com/photo-1596547609652-9cf5d8c76921?w=400&h=400&fit=crop" },
  { id: "ess-ghee", name: "Ghee", localName: "ঘি", category: "Essential", imageQuery: "ghee clarified butter", icon: "water_drop", image: "https://images.unsplash.com/photo-1600398232777-81196e3fa3b0?w=400&h=400&fit=crop" },
  ...
  { id: "ess-mustard-seeds", name: "Mustard Seeds", localName: "সরিষা", category: "Essential", imageQuery: "mustard seeds", icon: "spa", image: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=400&h=400&fit=crop" },
  { id: "ess-coconut", name: "Coconut", localName: "নারিকেল", category: "Essential", imageQuery: "coconut", icon: "eco", image: "https://images.unsplash.com/photo-1550828520-4cb496926fc9?w=400&h=400&fit=crop" },
  ...
  { id: "ess-jaggery", name: "Jaggery", localName: "গুড়", category: "Essential", imageQuery: "jaggery", icon: "grain", image: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=400&h=400&fit=crop" },

...
গুরুত্বপূর্ণ: "stepTimers" হলো প্রতিটি ধাপের জন্য সেকেন্ডে আনুমানিক সময়। "stepTips" হলো প্রতিটি ধাপের জন্য একটি সংক্ষিপ্ত রান্নার টিপস বা পরামর্শ (বাংলায়)। steps, stepTimers এবং stepTips এর length সমান হতে হবে। রান্নার ধাপ অনুযায়ী বাস্তবসম্মত সময় দাও (যেমন: কাটাকুটি ১২০ সেকেন্ড, ভাজা ৩০০ সেকেন্ড, সিদ্ধ ৬০০ সেকেন্ড ইত্যাদি)। টিপসগুলো যেন সেই ধাপের জন্য প্রাসঙ্গিক ও কাজে লাগে এমন হয়।`
